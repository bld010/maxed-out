...
export const HowTo = () => {
  return(
    <>
    <div>
      <h2>Is my favorite presidential candidate accepting donations from organizations that align with my views?</h2>
      <h2>Is my representative beholden to a certain industry? </h2>
      <h2>What types of individuals are supporting my senator?</h2>
      <p>Maxed's mission is to get voters thinking about the money spent on
